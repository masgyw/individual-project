package cn.gyw.individual.plugin.codegen;

import cn.gyw.individual.commons.enums.ValidStatus;
import cn.gyw.individual.commons.model.BaseDomain;
 ...
 */
@CgVo(pkgName = "cn.gyw.backend.house.vo")
@CgCreator(pkgName = "cn.gyw.backend.house.creator")
@CgUpdater(pkgName = "cn.gyw.backend.house.updater")
@CgRepository(pkgName = "cn.gyw.backend.house.repository")
@CgService(pkgName = "cn.gyw.backend.house.service")
@CgServiceImpl(pkgName = "cn.gyw.backend.house.service")
@CgQuery(pkgName = "cn.gyw.backend.house.query")
@CgMapper(pkgName = "cn.gyw.backend.house.mapper")
@CgController(pkgName = "cn.gyw.backend.house.controller")
@CgCreateRequest(pkgName = "cn.gyw.backend.house.request")
@CgUpdateRequest(pkgName = "cn.gyw.backend.house.request")
@CgQueryRequest(pkgName = "cn.gyw.backend.house.request")
@Entity
