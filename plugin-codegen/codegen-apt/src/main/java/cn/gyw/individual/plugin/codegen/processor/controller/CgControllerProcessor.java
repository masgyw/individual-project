...
public class CgControllerProcessor extends BaseCodeGenProcessor {
    ...
    public Class<? extends Annotation> getAnnotation() {
        return CgController.class;
    }

    @Override
    public String generatePackage(TypeElement typeElement) {
        return typeElement.getAnnotation(CgController.class).pkgName();
    }
    ...
    private Optional<MethodSpec> createMethod(String serviceFieldName, TypeElement typeElement, DefaultNameContext nameContext) {
        ...
        if (!containsNull) {
            return Optional.of(MethodSpec.methodBuilder("create" + typeElement.getSimpleName())
                    ...
                    .addCode(
                            CodeBlock.of("return DataResponse.success($L.create$L(creator));", serviceFieldName, typeElement.getSimpleName().toString())
                    )
                    .addJavadoc("createRequest")
                    .returns(ParameterizedTypeName.get(ClassName.get(DataResponse.class), ClassName.get(Long.class))).build());
        }
    ...
    private Optional<MethodSpec> updateMethod(String serviceFieldName, TypeElement typeElement, DefaultNameContext nameContext) {
        ...
        if (!containsNull) {
            return Optional.of(MethodSpec.methodBuilder("update" + typeElement.getSimpleName())
                    ...
                    .addCode(
                            CodeBlock.of("return $T.success($T.Success.getName());", DataResponse.class, CodeEnum.class)
                    )
                    .returns(ParameterizedTypeName.get(ClassName.get(DataResponse.class), ClassName.get(String.class)))
