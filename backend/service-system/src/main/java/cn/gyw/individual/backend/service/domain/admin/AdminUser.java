package cn.gyw.individual.backend.service.domain.admin;
...
@CgVo(pkgName = "cn.gyw.individual.backend.service.domain.admin.vo")
@CgCreator(pkgName = "cn.gyw.individual.backend.service.domain.admin.creator")
@CgUpdater(pkgName = "cn.gyw.individual.backend.service.domain.admin.updater")
@CgRepository(pkgName = "cn.gyw.individual.backend.service.domain.admin.repository")
@CgService(pkgName = "cn.gyw.individual.backend.service.domain.admin.service")
@CgServiceImpl(pkgName = "cn.gyw.individual.backend.service.domain.admin.service")
@CgQuery(pkgName = "cn.gyw.individual.backend.service.domain.admin.query")
@CgMapper(pkgName = "cn.gyw.individual.backend.service.domain.admin.mapper")
@CgController(pkgName = "cn.gyw.individual.backend.service.controller")
@CgCreateRequest(pkgName = "cn.gyw.individual.backend.service.api.request")
@CgUpdateRequest(pkgName = "cn.gyw.individual.backend.service.api.request")
@CgQueryRequest(pkgName = "cn.gyw.individual.backend.service.api.request")
@CgResponse(pkgName = "cn.gyw.individual.backend.service.api.response")
@Entity
