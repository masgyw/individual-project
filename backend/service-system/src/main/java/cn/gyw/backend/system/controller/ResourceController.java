...
public class ResourceController {
     ...
     * @return
     */
    @PostMapping(value = "getResourceTreeByPlatform/{id}")
    public DataResponse<List<ResourceTree>> getResourceTreeByPlatform(@PathVariable(name = "id") Long platformId) {
        return DataResponse.success(resourceService.getResourceTreeByPlatform(platformId));
    }
}
