package cn.gyw.backend.house.domain.house;
 ...
 */
@CgVo(pkgName = "cn.gyw.backend.house.domain.house.vo")
@CgCreator(pkgName = "cn.gyw.backend.house.domain.house.creator")
@CgUpdater(pkgName = "cn.gyw.backend.house.domain.house.updater")
@CgRepository(pkgName = "cn.gyw.backend.house.domain.house.repository")
@CgService(pkgName = "cn.gyw.backend.house.domain.house.service")
@CgServiceImpl(pkgName = "cn.gyw.backend.house.domain.house.service")
@CgQuery(pkgName = "cn.gyw.backend.house.domain.house.query")
@CgMapper(pkgName = "cn.gyw.backend.house.domain.house.mapper")
@CgController(pkgName = "cn.gyw.backend.house.controller")
@CgCreateRequest(pkgName = "cn.gyw.backend.house.api.request")
@CgUpdateRequest(pkgName = "cn.gyw.backend.house.api.request")
@CgQueryRequest(pkgName = "cn.gyw.backend.house.api.request")
@CgResponse(pkgName = "cn.gyw.backend.house.api.response")
@Entity
