package cn.gyw.individual.backend.service.domain.house;
 ...
 */
@CgVo(pkgName = "cn.gyw.individual.backend.service.domain.house.vo")
@CgCreator(pkgName = "cn.gyw.individual.backend.service.domain.house.creator")
@CgUpdater(pkgName = "cn.gyw.individual.backend.service.domain.house.updater")
@CgRepository(pkgName = "cn.gyw.individual.backend.service.domain.house.repository")
@CgService(pkgName = "cn.gyw.individual.backend.service.domain.house.service")
@CgServiceImpl(pkgName = "cn.gyw.individual.backend.service.domain.house.service")
@CgQuery(pkgName = "cn.gyw.individual.backend.service.domain.house.query")
@CgMapper(pkgName = "cn.gyw.individual.backend.service.domain.house.mapper")
