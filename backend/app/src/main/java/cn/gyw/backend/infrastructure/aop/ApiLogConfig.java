...
//
//     @Bean
//     public FilterRegistrationBean<OncePerRequestFilter> registration() {
//         FilterRegistrationBean<OncePerRequestFilter> registration = new FilterRegistrationBean<>(contentCachingRequestFilter());
